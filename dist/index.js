...
class DropboxUploader {
    constructor(dropbox, logger) {
         ...
         * @returns
         */
        this.uploadFile = (buffer, destination) => __awaiter(this, void 0, void 0, function* () {
            const response = yield this.dropbox.filesUpload({
                path: destination,
                contents: buffer,
                mode: { '.tag': 'overwrite' },
    ...
    static create({ accessToken }) {
        return new DropboxUploader(new dropbox_1.Dropbox({ accessToken }), console);
    }
}
